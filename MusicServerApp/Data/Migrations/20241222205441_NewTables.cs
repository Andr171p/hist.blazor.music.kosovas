    ...
    public partial class NewTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new TimeSpan(0, 0, 5, 0, 0), "Heavy Metal", new DateTime(1991, 7, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "Enter Sandman" },
                    { 2, 2, new TimeSpan(0, 0, 3, 0, 0), "Nu Metal", new DateTime(2000, 10, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "In the End" }
                });
